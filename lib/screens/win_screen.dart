...
class WinScreen extends StatefulWidget {
  ...
  _WinScreenState createState() => _WinScreenState(
      currentStage: currentStage, stepsTaken: stepsTaken, hours: hours, mins: mins, secs: secs, screenshotController: screenshotController);
}
                  ...
                  children: <Widget>[
                    ...
                    Stack(
                      ...
                      children: [
                        ...
                        Center(
                            child: Text((currentStage).toString(),
                                style: TextStyle(
                                    fontSize: ResponsiveValue(
                                      context,
                                      defaultValue: 50.0,
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      fontSize: ResponsiveValue(
                                        context,
                                        defaultValue: 30.0,
                                        valueWhen: [const Condition.largerThan(name: TABLET, value: 30.0)],
                                      ).value,
                                      fontWeight: FontWeight.bold,),
                                ),
                              ),
